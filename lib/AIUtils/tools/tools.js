...
import { EmojiReactionTool } from "./EmojiReactionTool.js"
import { FriendRequestTool } from "./FriendRequestTool.js"
import { GroupSignTool } from "./GroupSignTool.js"
import { UploadFileTool } from "./UploadFileTool.js"
import { JMComicTool } from "./JMComicTool.js"
import { OneBotUploadTool } from "./OneBotUploadTool.js"
import { WebFetchTool } from "./WebFetchTool.js"
import { ForwardMessageTool } from "./ForwardMessageTool.js"
import { AIworksTool } from "./AIworksTool.js"
...
const comfyUIImageTool = new ComfyUIImageTool()
...
const availableTools = [
  ...
  new BlackListTool(),
  new PokeTool(),
  new EmojiReactionTool(),
  new FriendRequestTool(),
  new GroupSignTool(),
  new UploadFileTool(),
  new JMComicTool(),
  new OneBotUploadTool(),
  new WebFetchTool(),
...
const allExecutableTools = [...availableTools, comfyUIImageTool, new ImageGeneratorTool()]
const toolMap = new Map(allExecutableTools.map(tool => [tool.name, tool]))

export function getToolsSchema() {
  return availableTools.map(tool => tool.function()).filter(Boolean)
}

export function getImageToolSchema() {
  const schema = comfyUIImageTool.function()
