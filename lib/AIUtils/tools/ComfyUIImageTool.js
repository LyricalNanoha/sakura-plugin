...
export class ComfyUIImageTool {
  name = "generateImage"
  description =
    "生成图片。支持动漫二次元(anima)和写实真人(krea2)两种风格。当聊天中有生图意图时使用。如果用户发送/引用了参考图片，设置 hasReferenceImage=true 使用风格参考模式。"
  ...
  parameters = {
    ...
    properties: {
      tags: {
        type: "string",
        description: "画面描述。根据 style 使用不同格式：\n- anime风格：用 Danbooru 标签（英文逗号分隔），如 1girl, kimono, standing, smile, cherry blossoms\n- realistic/krea2风格：用自然语言英文描述，如 A young woman in a kimono standing under cherry blossoms, smiling softly\n\n动漫风格时必须包含人物数量标签（1girl/2girls/1boy 1girl等）。如果画的不是「我自己」，需包含完整外貌描述。",
      },
      style: {
        type: "string",
      ...
      hasReferenceImage: {
        type: "boolean",
        description: "用户是否提供了参考图片（发送或引用了图片）。如果有参考图则设为true，会使用风格参考模式生图。默认false。",
      },
      isNsfw: {
        type: "boolean",
