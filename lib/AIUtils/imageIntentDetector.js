...
调用规则：
- tags：根据 style 使用不同格式：
  · anime风格：Danbooru 标签（英文逗号分隔），包含人物数量标签(1girl/2girls等)
    示例: "1girl, bare legs, thighs, sitting, looking at viewer, close-up"
  · realistic/krea2风格：英文自然语言描述
...
- 用户发送图片说"参考这个风格" → style:"realistic", hasReferenceImage:true, tags:"Portrait photo in the reference art style"
